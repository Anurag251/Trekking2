    ...
    >
      <section>
        <div className="wrapper">
          <div className="main-title">Dates & Prices</div>
          <div className="main-container">
            ...
            <div className="year-list">
              <div
                className={`item ${selectedYear === "2023" ? "active" : ""}`}
              >
                <div
              ...
              <div
                className={`item ${selectedYear === "2024" ? "active" : ""}`}
              >
                <div
                  className="item-title"
              ...
              <div
                className={`item ${selectedYear === "2025" ? "active" : ""}`}
              >
                <div
                  className="item-title"
